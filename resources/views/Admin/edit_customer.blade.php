                ...
                <div class="col-lg-7">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-4">New Customer</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ URL::to('update-customer/' . $customers->id) }}"
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" name="name" value="{{ $customers->name }}"
